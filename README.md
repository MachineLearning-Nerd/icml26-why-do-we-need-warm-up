...
| [`orx/exact-imagenet32-vision-curvature`](https://github.com/MachineLearning-Nerd/icml26-repro-a6fo32UnpU-why-do-we-need-warm-up-a-theoretical-perspective/tree/orx/exact-imagenet32-vision-curvature) | ResNet50/ViT-Tiny, official ImageNet32, three seeds | `uv run --frozen python -m warmup_repro.run` | Running; final terminal evidence will be recorded before release | HF cpu-upgrade, 64 threads |
